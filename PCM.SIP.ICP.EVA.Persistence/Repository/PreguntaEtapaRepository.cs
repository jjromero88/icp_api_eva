...
{
    public class PreguntaEtapaRepository : IPreguntaEtapaRepository
    {
        private readonly DapperContext _context;

        public PreguntaEtapaRepository(DapperContext context)
        {
            _context = context;
        }

        public Response Insert(PreguntaEtapa entidad)
        {
            throw new NotImplementedException();
        }

        public Response Update(PreguntaEtapa entidad)
        {
            throw new NotImplementedException();
        }

        public Response Delete(PreguntaEtapa entidad)
        {
            throw new NotImplementedException();
        }

        public Response<dynamic> GetById(PreguntaEtapa entidad)
        {
            throw new NotImplementedException();
        }

        public Response<List<dynamic>> GetList(PreguntaEtapa entidad)
        {
