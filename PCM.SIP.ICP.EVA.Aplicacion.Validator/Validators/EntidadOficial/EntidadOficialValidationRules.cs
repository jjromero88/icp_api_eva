...
{
    public class EntidadOficialIdRequestValidator : AbstractValidator<EntidadOficialIdRequestDto>
    {
    ...
    public class EntidadOficialInsertRequestValidator : AbstractValidator<EntidadOficialInsertRequestDto>
    {
    ...
    public class EntidadOficialUpdateRequestValidator : AbstractValidator<EntidadOficialUpdateRequestDto>
    {
